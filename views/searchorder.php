...
?>
        <?php foreach ($order as $item):
            ...
            $orderID = $item['id'];
            $orderDetail = getRaw("SELECT * FROM order_details WHERE order_id=$orderID"); ?>
            <div class="mx-auto w-50 my-5">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><img style="width: 50px;height: 50px;object-fit: cover;" src="../public/img/product/chitiet/<?= $itemDetail['img'] ?>"></td>
