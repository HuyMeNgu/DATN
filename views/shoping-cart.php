      ...
      <div class="col-lg-12">
        <div class="shoping__cart__table">
          <table>
            ...
            <tbody class="cart-list" data-empty="<?php echo empty($cart) ? 'true' : 'false'; ?>">
              <script>
                $(document).ready(function() {
                  // Kiểm tra giá trị của data-empty trong tbody
                  if ($('.cart-list').data('empty') === 'true') {
                    $('.cart-list').hide(); // Ẩn tbody nếu giỏ hàng rỗng
                  }
                });
              </script>
              <?php
              if (empty($cart)) {
                echo "<h3 class='text-center mb-5'>Giỏ hàng của bạn đang rỗng!</h3>";
              }
